...
//		genesParametro1.add(parametro3);
		...
		Cromosoma cromosoma1 = Cromosoma.generarCromosomaAleatorio(genesParametro1); 
//				CreadorObjetos.crearCromosomaConGenesInicializados(genesParametro1);
...
//		Gen parametro6 = CreadorObjetos.crearGenConValor("z",200, 300, 3, 5);
		...
		genesParametro2.add(parametro5);
//		genesParametro2.add(parametro6);
		Cromosoma cromosoma2 =Cromosoma.generarCromosomaAleatorio(genesParametro2); 
//				CreadorObjetos.crearCromosomaConGenesInicializados(genesParametro2);
...
//		Gen parametro9 = CreadorObjetos.crearGenConValor("z",200, 300, 3, 9);
		...
		genesParametro3.add(parametro8);
//		genesParametro3.add(parametro9);
		Cromosoma cromosoma3 = Cromosoma.generarCromosomaAleatorio(genesParametro3); 
//				CreadorObjetos.crearCromosomaConGenesInicializados(genesParametro3);
...
//		Gen parametro12 = CreadorObjetos.crearGenConValor("z",200, 300, 3, 12);
		...
		genesParametro4.add(parametro11);
//		genesParametro4.add(parametro12);
		Cromosoma cromosoma4 = Cromosoma.generarCromosomaAleatorio(genesParametro1); 
//				CreadorObjetos.crearCromosomaConGenesInicializados(genesParametro4);
...
//		Gen parametro15 = CreadorObjetos.crearGenConValor("z",200, 300, 3, 14);
		...
		genesParametro5.add(parametro14);
//		genesParametro5.add(parametro15);
		Cromosoma cromosoma5 = Cromosoma.generarCromosomaAleatorio(genesParametro1);
//		CreadorObjetos.crearCromosomaConGenesInicializados(genesParametro5);
